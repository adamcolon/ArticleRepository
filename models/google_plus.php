...
class GooglePlus {
	...
	/**
	 * Retrieve Stream Data JSON decoded as an associative array
	 * @param int $results_per_page
	 * @param string $stream_next
	 */
	...
	/**
	 * return annotation of specific post stripping out hashtags and returning them as a seperate array
	 * @param array $item
	 */
	...
	/**
	 * 
	 * massage google post feed item into an array of post data for wordpress
	 * @param array $item
	 * @return array
	 */
	...
	/**
	 * 
	 * Loop through all attachments and extract content for the post
